...
static void qspi_FlushRx(void) {
  qspi_reg_write(GQSPI_FIFO_CTRL_OFST, GQSPI_FIFO_CTRL_RST_RX_FIFO_MASK);
  /*
...
static void qspi_FlushTx(void) {
  qspi_reg_write(GQSPI_FIFO_CTRL_OFST, GQSPI_FIFO_CTRL_RST_TX_FIFO_MASK);
  /*
   * Wait for FIFO to clear and Empty flag to raise.
   */
...
static void qspi_FlushGen(void) {
  qspi_reg_write(GQSPI_FIFO_CTRL_OFST, GQSPI_FIFO_CTRL_RST_GEN_FIFO_MASK);
  /*
   * Wait for FIFO to clear and Empty flag to raise.
   */
